...
const desc =
  "Eduaid theme number one world class university in the world. There are students studying always in this university all the time.";
    ...
    <footer className="style-2">
      ...
      {/* footer section */}
           <div className="footer-bottom ">
                   <div className="section-wrapper row-cols-xl-3">
                               <p>&copy; 2024 <Link to="/" >Shop Cart</Link> Designed By  <a href="/" target="_blank">Ajjayya G V </a> </p>
